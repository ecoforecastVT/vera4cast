...
df <- arrow::open_dataset(arrow::s3_bucket(config$summaries_bucket, endpoint_override = config$endpoint, anonymous = TRUE)) |> 
  dplyr::filter(duration == 'P1D') |> 
  # arrow::open_dataset("../cache/summaries/duration=P1D") |> 
